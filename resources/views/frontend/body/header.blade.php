                ...
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        <li><a href="#"><i class="icon fa fa-user">
                                    @if(session()->get('language') == 'arabic')حسابك الخاص
                                    @else your Account   @endif
                                </i>My Account</a></li>
                        ...
                        <li>
                            @auth()
                                <a href="{{route('login')}}">
                                    <i class="icon fa fa-lock"></i> User profile </a></li>
                            @else
                                <a href="{{route('login')}}">
                                    <i class="icon fa fa-lock"></i>Login / Register</a></li>
                            @endauth
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small">
                            <a href="#" class="dropdown-toggle"
                                    ...
                                    @if(session()->get('language') == 'arabic') اللغة العربية
                                        @else English Language  @endif
                                </span><b class="caret"></b></a>
                            <ul class="dropdown-menu">

                                @if(session()->get('language') == 'english')
                                    <li><a href="{{route('arabic.lang')}}">Arabic</a></li>
                                @else
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    ...
                    <div class="logo"> <a href="{{url('/')}}">
                            <img src="{{asset('frontend/assets/images/logo.png')}}" alt="logo"> </a> </div>
                    <!-- /.logo -->
                    <!-- ============================================================= LOGO : END ============================================================= --> </div>
                <!-- /.logo-holder -->
                        ...
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw"> <a href="{{url('/')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                                        @if(session()->get('language') == 'arabic')الصفحة الرئيسية
                                ...
                                @foreach($categories as $category)  <!--start Category -->
                                        ...
                                        <li>
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    @endphp
                                                    @foreach($subcateogries as $sub)  <!--start subCategory -->

                                                    <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        <a href="{{url('subcategory/product/'.$sub->id.'/'.$sub->subcategory_slug_en)}}">
                                                        <h2 class="title">
                                                            @if(session()->get('language') == 'arabic') {{$sub->subcategory_name_ar}}
                                                            @else {{$sub->subcategory_name_en}}  @endif
                                                            </h2>
                                                        </a>
                                                     ...
                                                     @endphp
                                                        ...
                                                        <ul class="links">
                                                            <li><a href="{{ url('subsubcategory/product/'.$subsub->id.'/'.$subsub->subsubcategory_slug_en ) }}">
                                                                    @if(session()->get('language') == 'arabic') {{$subsub->subsubcategory_name_ar}}
                                                                    @else {{ $subsub->subsubcategory_name_en }}  @endif
                                                                </a></li>
                                                        </ul>
                                                            @endforeach
                                                    </div>
